...
import { handleBulkCouncellingFeeUpload } from '../server-actions-fee-collection/actions';
...
const downloadCsvTemplate = () => {
  ...
  link.setAttribute('download', `bulk_councellingfeeupdate_template-${new Date().toISOString()}.csv`);
  ...
  const [converting, setConverting] = useState<boolean>(false);
        ...
        const handleUpload = async () => {
          ...
          try {
            ...
            if (Array.isArray(data) && data.length > 0) {
              ...
              const response = (await handleBulkCouncellingFeeUpload(formData)) as Resp;
        ...
        return (
          <div className="w-full h-full flex flex-col justify-center items-center gap-3">
            <h1 className="text-xl">Bulk Councelling Fee Update Form</h1>
              ...
              <li>
                ...
                <div className="border rounded-lg p-2 bg-red-500">
                  <ul className="list-disc px-4 text-white">
                    <li>Enter valid <b>Registration</b> number</li>
                    <li>Enter valid <b>Councelling</b> amount</li>
                  </ul>
                </div>
              </li>
...
export default BulkOjeeFeeUpdateForm