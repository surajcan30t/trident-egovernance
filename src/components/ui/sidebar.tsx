  ...
  return (
    <button
      ...
      className={cn(
        ...
        " after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground2",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
